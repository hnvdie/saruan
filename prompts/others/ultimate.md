...
Nama tema       : [isi]
Konsep & mood   : [isi — deskripsikan nuansa, karakter, feel]
Palet warna     : [isi — hex atau deskripsi]
Referensi visual: [isi — era, budaya, gaya arsitektur, mood sinematik]
Cover asset     : [isi — "pakai cover.jpg dari saya" / atau deskripsikan gambarnya]
Custom assets   : [isi — sebutkan file apa saja yang akan kamu sediakan, atau "biarkan AI tentukan"]
